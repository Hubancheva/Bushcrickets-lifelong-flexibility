...
ggplot(data = bc_data1, aes(x=stimuli, y = pause, fill = age)) +
  theme_classic()+
  scale_y_log10(breaks = c(25,50,100, 200,500,1000,2000, 5000, 10000, 20000)) +
  ...
  ylab("Pause duration (ms)")+
  # geom_split_violin(trim = TRUE, alpha = 0.6, color = NA)+
 geom_boxplot(position = "dodge", alpha = 0.5) +
  ...
  stat_summary(geom = "point",
               fun= f1, size = 4,
               position=position_dodge(width=0.8)) -> p3a

## same as previous plot but visualized with split violin plot

#Function for ggplot2 that creates split violins
...
# Some resources from the web

Nice resource with lme (linear mixed effects) and a lot of plots
...
https://www.ncbi.nlm.nih.gov/pmc/articles/PMC2888330/
